...
|---------------------|---------------------|--------------|
| Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software |  Vega Sayritupac Paul Kennedin <br> __TB1__ <br>* __Remplazar__<br>Morales Quispe Brayan Smith <br> __TB1__ <br>* Ayude al equipo a organizarnos para el desarrollo de las partes del tb1. <br> Miranda Sinarahua Piero <br> __TB1__ <br>* Contribuí en el desarrollo de la recoleccion de informacion y analisis de datos los cuales fueron empleados para la elaboración de soluciones relacionadas al propósito del proyecto. <br>Taype Fernandez Leonardo <br> __TB1__ <br>* __Participé en puntos específicos del trabajo y contribuí a las soluciones del proyecto con responsabilidad.__<br>  Becerra Llempen Fabiola Dayane <br> __TB1__ <br>* __Remplazar__<br>            |<br>_Fabiola Becerra_<br> Realizar el formato del trabajo grupal es importante para el rendimiento y la satisfacción del trabajo. Además, la correcta organización para la recopilación de información.  <br>_Piero Miranda_<br>   Es primordial tener en cuenta los datos exteriores para elaborar una solucion lo mas acorde a lo que el cliente requiera. El trabajo en equipo es escencial para conseguir los objetivos planteados.   | 
| Conoce al menos un sector empresarial o dominio de aplicación de soluciones de software | Vega Sayritupac Paul Kennedin <br> __TB1__ <br>* __Remplazar__<br>Morales Quispe Brayan Smith <br> __TB1__ <br>* Conosco una parecida a nuestra aplicacion siendo enfocada al sector construccion en la buqueda de fontaneros y electricistas. <br> Miranda Sinarahua Piero <br> __TB1__ <br>* Reconozco cual sera el segmento objetivo y en base a ello elaboro propuestas para el proyecto. <br>Taype Fernandez Leonardo <br> __TB1__ <br>* __Participo en las encuestas brindandas a el publico objetivo. También realizo cambios específicos en algunos puntos de los capítulos.__<br>  Becerra Llempen Fabiola Dayane <br> __TB1__ <br>* __Remplazar__<br>                   | <br>_Fabiola Becerra_<br>Las implementaciones de las funcionalidades de la aplicación para entender mejor la solución a los requerimientos. Además, se observan los problemas que los clientes obtienen con la atención como las soluciones de ideas.  <br>_Piero Miranda_<br>La solucion implementada toma en cuenta lo recolectado previamente y se implementa de tal forma que el cliente quede satisfecho con lo solicitado.     | 
-----
...
![Variaciones de letras](/Docs/Capitulo%20IV/4.1.%20Style%20Guidelines/images/letters.png)
...
Versión móvil:
![Mobile](/Docs/Capitulo%20IV/4.1.%20Style%20Guidelines/images/design-mobile.png)
...
![](/Docs/Capitulo%20IV/4.7.%20Software%20Object-Oriented%20Design/images/diagrama-clases.png)
