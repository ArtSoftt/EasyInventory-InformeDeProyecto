...
|11|UT08| Sistema de Autenticación y registro| Como desarrollador quiero implementar un sistema de autenticación y registro |5|
|12|UT01| Configuración del backend| Como desarrollador quiero poder editar, agregar, eliminar el inventario de productos de cada cliente|8|
|13|UT02| Configurar la base de datos| Como desasrrollador quiero poder configurar una base de datos para almacenar información que necesito |5|
|14|UT04|Funcionalidad de búsqueda avanzada| Como desarrollador quiero implementar la funcionalidad de búsqueda avanzada con filtros|5|
|15|UT06|Diseño de interfaz de usuario| Como desarrollador quiero diseñar una interfaz de usuario atractiva y fácil de usar para una experiencia agradable| 5|
|16|UT03|Integración de API de correo| Como desarrollador quiero integrar una API de correos para poder enviar a cada cliente un reporte de información|5|
|17|UT05| Optimización del rendimiento de la aplicación| Como desarrollador quiero optimizar el rendimiento de la aplicación para una experiencia rápida y fluida| 5|
|18|UT07| Mantenimiento de la aplicación| Como desarrollador quiero establecer un plan de mantenimiento para saegurar el funcionamiento continuo de la aplicaión|8|
